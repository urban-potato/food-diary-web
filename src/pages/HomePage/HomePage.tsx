...
const Homepage: FC = () => {
  return (
    <section className="relative bg-food_img bg-no-repeat w-full h-full flex-grow bg-bg_position rounded-3xl">
      <section className="flex flex-col gap-y-3 max-w-4xl">
        <section
          className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl 2xl:text-7xl px-5 pt-5 
        ...
        <section className="text-lg md:text-xl lg:text-2xl 2xl:text-2xl px-5 sm:px-11 md:px-16 lg:px-16">
          <div className="relative">
